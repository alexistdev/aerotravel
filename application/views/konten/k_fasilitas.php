...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1>Fasilitas Destinasi Wisata</h1>
				</div>
				<div class="col-sm-6">
			...
			<div class="row">
				...
				<div class="col-12 col-sm-12">
					...
					<div class="card card-dark card-tabs">
						...
						<div class="card-body">
						<span data-toggle="modal" id="tombolTambah" data-target="#modalTambah" data-id="<?= sanitasi($idFasilitas); ?>">
							...
							<div class="tab-content mt-2" id="custom-tabs-one-tabContent">
								<div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
									...
									<table id="tableOpen" class="table table-bordered table-hover" style="width: 100%">
										...
										<tr>
											...
											<th class="text-center" width="20%">Nama Fasilitas</th>
											<th class="text-center" width="10%">Action</th>
										</tr>
										</thead>
										<tbody>
										<?php $no = 1;
										foreach($openTrip->result_array() as $rowFasilitas) :?>
											<tr>
												<td class="text-center"><?= $no++; ?></td>
												<td class="text-center"><?= sanitasi($rowFasilitas['judul_destinasi']); ?></td>
												<td class="text-center"><?= (sanitasi($rowFasilitas['type']) == 1)? "Open Trip" : "Private Trip"; ?></td>
												<td><?= sanitasi($rowFasilitas['nama_fasilitas']); ?></td>
												<td class="text-center">
													<a href="<?= base_url('Destinasi/hapus_fasilitas/'.encrypt_url(sanitasi($rowFasilitas['id_destinasi'])).'/'.encrypt_url(sanitasi($rowFasilitas['id_fasilitas']))); ?>"><button class="btn btn-danger"><i class="fas fa-trash"></i></button></a>
												</td>
											</tr>
								...
								<div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
									<table id="tablePrivate" class="table table-bordered table-hover" style="width: 100%">
										...
										<tbody>
										<?php $no = 1;
										foreach($privateTrip->result_array() as $rowFasilitas) :?>
											<tr>
												<td class="text-center"><?= $no++; ?></td>
												<td class="text-center"><?= sanitasi($rowFasilitas['judul_destinasi']); ?></td>
												<td class="text-center"><?= (sanitasi($rowFasilitas['type']) == 1)? "Open Trip" : "Private Trip"; ?></td>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?= base_url('Destinasi/fasilitas_tambah'); ?>" method="post">
					<!-- Pilih Type Trip	-->
					<div class="row">
						<div class="col-md-12">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label for="namaFasilitas">Nama Fasilitas <span class="text-danger">*</span></label>
								<input type="text" name="namaFasilitas" id="namaFasilitas" maxlength="120" class="form-control" value="<?= set_value('namaFasilitas'); ?>" placeholder="Nama Fasilitas" required="required">
							</div>
						</div>
					</div>
					<!-- Destinasi	-->
